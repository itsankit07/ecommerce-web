...
const ProductSlider = () => {
  const calculateTimeLeft = () => {
    const endDate = new Date("Jul 31, 2024 12:00:00").getTime();
  ...
  return (
    <>
      <div className="w-[1170px] h-[493px] mx-[135px] flex flex-col gap-8">
        <div className="flex gap-4">
          <div className="w-[20px] h-[40px] border-2 rounded bg-orange-700"></div>
          <h4 className="text-orange-700 flex items-center font-poppin font-bold">
            Todays
          </h4>
        </div>
        <div className="flex gap-20">
          ...
          <div className="absolute flex gap-2 left-3/4">
            <button
        ...
        <div className="max-w-[1270px] h-[350px] overflow-x-scroll overflow-hidden scroll-smooth products-class">
      ...
      <div className="bg-orange-600 w-[234px] my-[60px] h-[56px] border rounded flex justify-center items-center py-4 m-auto text-white cursor-pointer">
        View All Products
      </div>
    </>
  );
