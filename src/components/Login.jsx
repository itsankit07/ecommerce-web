      ...
      <div className="w-4/12 flex items-center py-[125px] justify-end">
        <div className="flex flex-col gap-12">
          ...
          <form action="" className="flex flex-col  gap-10 mt-3">
            ...
            {!isLogin && (<button className="border-black border-2 py-3">
              Sign up with Google
            </button>)}

            {
                !isLogin && (<span className="flex justify-center items-center">
                    Already have account ? <a onClick={handleLogin} className="cursor-pointer">Login</a>
                  </span>)
            } 
               {
                isLogin && (<span className="flex justify-center items-center">
                    Do not have a account...? <a onClick={handleLogin} className="cursor-pointer">Create Here</a>
                  </span>)
            } 
          </form>
        </div>
